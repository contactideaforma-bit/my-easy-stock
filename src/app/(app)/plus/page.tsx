...
import { IconUsers, IconTruck, IconChart, IconLogout, IconClipboard, IconTag, IconTrash, IconCash, IconBuilding, IconInvoice } from '@/components/Icons';
...
export default function PlusPage() {
  ...
  const items = [
    ...
    { href: '/compta', label: 'Comptabilité', desc: 'Récap sur période, exports Excel pour le comptable', icon: IconInvoice },
